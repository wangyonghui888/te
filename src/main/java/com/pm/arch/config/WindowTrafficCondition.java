...
@Slf4j
public class WindowTrafficCondition implements RequestCondition<WindowTrafficCondition> {
    ...
    public WindowTrafficCondition(String apiVersion) {
        this.apiVersion = apiVersion;
    }


    @Override
    public WindowTrafficCondition combine(WindowTrafficCondition other) {
        return new WindowTrafficCondition(other.apiVersion);
    }

    @Override
    public WindowTrafficCondition getMatchingCondition(HttpServletRequest request) {
    ...
    @Override
    public int compareTo(WindowTrafficCondition other, HttpServletRequest request) {
